...
const RollDiceTest = () => {
    ...
    const higherBtn = () => {
        ...
        if (newTotal > total) {
            setMessage(`You win! ${newTotal} is higher than ${total}.`);
        } else if (newTotal === total) {
            setMessage('It\'s a tie! The total is the same as the previous roll.');
        } else {
            setMessage(`You lose! ${newTotal} is not higher than ${total}.`);
        }
    ...
    const lowerBtn = () => {
        ...
        if (newTotal < total) {
            setMessage(`You win! ${newTotal} is lower than ${total}.`);
        } else if (newTotal === total) {
            setMessage('It\'s a tie! The total is the same as the previous roll.');
        } else {
            setMessage(`You lose! ${newTotal} is not lower than ${total}.`);
        }
        setTotal(newTotal);  // Opdaterer total til nye value
    };
